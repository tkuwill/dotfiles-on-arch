...
static const char *fonts[]          = { "NotoSansMonoCJKTC:style=Bold:size=16" };
...
static const char *termcmd[]  = { "xfce4-terminal", "--maximize", "--hide-menubar", "--hide-toolbar", "--hide-scrollbar", "--hide-borders", NULL };
